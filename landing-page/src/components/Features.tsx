...
const FEATURES = [
  ...
  },
  {
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.042 21.672L13.684 16.6m0 0l-2.51 2.225.569-9.47 5.227 7.917-3.286-.672zM12 2.25V4.5m5.833.166l-1.333 1.333M19.5 10.5H18M7.5 18.167L3.383 21m0 0l2.284-10.18m0 0L3 7.5l3.768 2.5m0 0l.447-1.716" />
      </svg>
    ),
  ...
  },
  {
    ...
    title: "Privacy First",
    description:
      "Your conversations never leave your device unless you choose to share. End-to-end encrypted analysis with zero data retention.",
    label: "SECURE",
  },
];
    ...
    <section id="features" className="relative px-6 py-24 sm:py-32">
      ...
      <AnimatedSection className="mx-auto max-w-2xl text-center mb-16 sm:mb-20">
        ...
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight text-nothing-white">
          Engineered for the{" "}
          <span className="text-neon-red">Modern Dater</span>
        </h2>
        <p className="mt-4 text-nothing-text-secondary text-sm sm:text-base leading-relaxed max-w-lg mx-auto">
          Every feature is built on real conversation data and tested for maximum engagement.
        </p>
      </AnimatedSection>
