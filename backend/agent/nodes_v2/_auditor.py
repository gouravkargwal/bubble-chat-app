...
* Persona labeling (NARROW — the litmus is DOES vs IS): fail ONLY a verdict on WHO SHE IS, never a guess about what she DOES. ALLOW behavior/habit assumptions EVEN in "type who" form — "the type who treats dates like a job interview", "you probably plan dates down to the chai order", "bet you take 500 photos to get one", "talent for switching looks" are guesses about ACTIONS she can deny → PASS. FAIL only an identity / character / aesthetic / zodiac VERDICT — "you've got influencer energy", "you're the artsy/soft type", "you have a filmy aesthetic", "scorpio so you think everyone's wrong" (telling her who she IS). If a "type who" line is followed by a concrete behavior, it PASSES. When unsure, it PASSES.
