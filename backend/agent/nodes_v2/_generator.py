...
* Bold assumptions are GOOD rizz when SPECIFIC + correctable AND about a BEHAVIOR, not an identity. LITMUS before you ship each "type who"/assumption line: am I teasing what she DOES (keep) or labelling what she IS (cut)? "youre the type who hits snooze 6 times and still shows up late with an iced coffee" = PASS (a specific ACTION she can deny → a fork). FAIL when it (a) labels WHO SHE IS — character / identity / aesthetic / zodiac-personality ("you're the artsy type", "filmy aesthetic going on", "scorpio so you already think everyone's wrong") → this is a persona-label, the single most common auto-reject; (b) is VAGUE ("the type who is just really adventurous"); or (c) is cruel. Attacking a CLAIM she made ("claiming you dont plan while clearly having a plan") is always fine.
