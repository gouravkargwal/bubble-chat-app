...
from app.prompts.profile_optimizer import (
    ALLOWED_LANGS,
    MAX_BLUEPRINT_SLOTS,
    PROFILE_BLUEPRINT_SCHEMA,
    build_blueprint_system_prompt,
...
async def generate_blueprint(
    ...
    system_prompt = build_blueprint_system_prompt(lang)
    user_prompt = build_blueprint_user_prompt(available_count, photos_json)
